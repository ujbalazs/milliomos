...
public class Questions {
    ...
    String[][] questions = {
            {"Miből készül a sajt?", "Tojásbol", "Tejből", "Lisztből", "Cukorból", "b"}, //1.
            {"Melyik ország fővárosa Dublin?", "Izland", "India", "Írország", "Irak", "c"}, //2.
            {"Ki volt Rózsa Sándor?", "Muzsikus", "Szinész", "Költő", "Betyár", "d"}, //3.
            {"Hány vércsoport létezik?", "Nyolc", "Tíz", "Kettő", "Négy", "d"}, //4.
            {"Hol született Petőfi Sándor?", "Kiskőrösön", "Nagykőrösön", "Nagyszalontán", "Kisszalontán", "a"}, //5,
            {"Ki volt Gandalf, A Gyűrűk Urában?", "Mágus", "Hobbit", "Törp", "Tünde", "a"}, //6,
            {"Milyen autómárka a Ferrari?", "Spanyol", "Olasz", "Francia", "Német", "b"}, //7.
